...
const items = [
  {
    title: 'Open Source',
    desc: 'MIT licensed. Fork it, extend it, own it.',
    icon: (
  ...
  {
    title: 'Self-hosted',
    desc: 'Your data stays on your infrastructure.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
  ...
  {
    title: 'Extensible',
    desc: 'Plugin architecture. Add your own tools.',
    icon: (
      <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {items.map((item, i) => (
            <motion.div
              ...
              whileHover={{ y: -4, borderColor: 'rgba(88,166,255,0.3)' }}
              className="p-6 rounded-xl border border-dark-300 bg-dark-100/50 text-center hover:bg-dark-100 transition-all cursor-default"
            >
